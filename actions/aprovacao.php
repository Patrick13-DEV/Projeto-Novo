    ...
    if (
        ...
        if (
            ...
            header(
                "Location: " .
                    ROOT_PATH .
                    "pages/profissional/aplicacao/dashboard.php"
            );
        ...
        try {
            ...
            if ($update->execute()) {
                ...
                if ($update->rowCount() > 0) {
                    ...
                    $_SESSION['mensagem'] =
                        "Agendamento não encontrado ou já foi processado.";
                ...
                $_SESSION['mensagem'] =
                    "Ocorreu um erro ao alterar o agendamento.";
