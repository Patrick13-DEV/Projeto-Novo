...
<body>
    ...
    <div class="min-h-screen bg-sky-300 flex items-end md:items-center justify-center">
        ...
        <div class="bg-white w-full md:max-w-7xl
            ...
            <div class="flex flex-col md:flex-row">
                ...
                <!-- Lado Esquerdo -->
                <form action="/InovaVida/actions/cadastro_profissional.php" method="post" class="w-full lg:w-2/5 p-6 md:p-5 lg:p-10 flex flex-col gap-5 items-center" data-password-validator>
                    <h1 class="text-4xl lg:text-5xl font-poppins font-semibold "> Cadastre-se</h1>
                    <p class="text-gray-500 text-xs px-18 md:px-0 font-poppins form-extralight">Preencha com as
                        informações necessarias para seu cadastro</p>
                    ...
                    <div
                        ...
                        <div class="bg-sky-800 size-[55px] rounded-lg flex items-center justify-center"> <svg
                                class="stroke-1 stroke-white size-12" xmlns="http://www.w3.org/2000/svg" fill="none"
                    ...
                    <div
                        class="border-gray-300 rounded-sm border-3 md:border-2 w-full h-[76px] pl-3 gap-4 flex items-center text-2xl">
                        <div class="bg-sky-800 size-[55px] rounded-lg flex items-center justify-center"> <svg
                                class="stroke-white size-12" xmlns="http://www.w3.org/2000/svg" fill="none"
                                viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round"
                        ...
                        <input class="flex-1 w-full font-poppins outline-none bg-transparent" type="password" name="senha" id="senha_profissional" data-password-input placeholder="Senha" minlength="6" required>
                        <button type="button" class="rounded-full border border-sky-800 px-3 py-2 text-sm font-semibold text-sky-800" data-password-toggle="senha_profissional">
                    ...
                    <div
                        ...
                        <input class="flex-1 w-full font-poppins outline-none bg-transparent" type="password" name="confirmar_senha" id="confirmar_senha_profissional" data-password-confirm placeholder="Confirme a Senha" minlength="6" required>
                        <button type="button" class="rounded-full border border-sky-800 px-3 py-2 text-sm font-semibold text-sky-800" data-password-toggle="confirmar_senha_profissional">
                            <span data-password-toggle-label>Mostrar</span>
                        </button>
                    </div>
                    <button
                        type="submit"
                        class="text-2xl max-w-sm w-full rounded-full bg-sky-800 px-4 py-4 font-semibold text-white delay-150 duration-300 ease-in-out hover:-translate-y-1 hover:scale-110 hover:bg-indigo-500">
                        <span class="font-poppins">Continuar</span>
                    </button>
                    <a href="./login.php" class="text-blue-500 text-lg md:text-xl">Já tem uma conta? Faça login</a>
                </form>
                <!-- Lado Direito -->
                <div class="hidden lg:flex lg:w-3/5
            bg-gradient-to-br from-sky-100 to-cyan-400
