    ...
    <div class="min-h-screen bg-sky-300 flex items-end md:items-center justify-center">
        ...
        <div class="bg-white w-full lg:max-w-7xl rounded-t-[2.5rem] md:rounded-[2.5rem] shadow-lg overflow-hidden ">
            ...
            <div class="flex flex-col md:flex-row">
                ...
                <form action="<?= ROOT_PATH ?>actions/cadastro_profissional.php" method="post" class="w-full lg:w-2/5 p-6 md:p-5 flex flex-col gap-4 items-center" >
                <input type="hidden" name="etapa" value="cadastro">
                    ...
                    <div class="border-gray-300 rounded-sm border-3 md:border-2 w-full h-[70px] pl-3 pr-3 gap-4 flex items-center text-2xl">
                        ...
                        <input class="flex-1 w-full font-poppins outline-none bg-transparent" type="password" name="senha" id="senha_profissional" data-password-input placeholder="Senha" minlength="6">
                    </div>
                    ...
                    <div class="border-gray-300 rounded-sm border-3 md:border-2 w-full h-[70px] pl-3 pr-3 gap-4 flex items-center text-2xl">
                        ...
                        <input class="flex-1 w-full font-poppins outline-none bg-transparent" type="password" name="confirmar_senha" id="confirmar_senha_profissional" data-password-confirm placeholder="Confirme a Senha" minlength="6">
                    </div>
