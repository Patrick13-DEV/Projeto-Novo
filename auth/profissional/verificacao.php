        ...
        <div
            ...
            <div class="flex flex-col lg:flex-row h-full">
                ...
                <div class="w-full lg:w-2/5 p-6 md:p-8 lg:p-10 flex flex-col justify-center items-center gap-6">
                    ...
                    <button
                        class="text-2xl max-w-sm w-full rounded-full bg-sky-800 py-4 font-semibold text-white duration-300 hover:-translate-y-1 hover:bg-indigo-500">
                        <a href="../aplicacao/dashboard.php" class="flex justify-center items-center gap-2">
                            Verificar
                        </a>
                    </button>
