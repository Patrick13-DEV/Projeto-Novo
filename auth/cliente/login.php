        ...
        <div class="bg-white w-full lg:max-w-7xl rounded-t-[2.5rem] md:rounded-[2.5rem] shadow-lg overflow-hidden">
            <div class="flex flex-col md:flex-row">
                <form action="/InovaVida/actions/login.php" method="post" class="w-full lg:w-2/5 p-6 md:p-8 lg:p-10 flex flex-col gap-5 items-center lg:min-h-[778px]">
                    <h1 class="text-4xl lg:text-5xl font-poppins font-semibold">Faça seu Login</h1>
                    <p class="text-gray-500 text-xs md:text-sm font-poppins text-center">Entre com as informações cadastradas para acessar sua conta.</p>
                    ...
                    <div class="border-gray-300 rounded-sm border-3 md:border-2 w-full h-[76px] pl-3 pr-3 gap-4 flex items-center text-2xl">
                        ...
                        <input class="flex-1 font-poppins outline-none bg-transparent" type="password" name="senha" id="senha_login_cliente" placeholder="Senha" required>
                    ...
                    <button type="submit" class="text-2xl max-w-sm w-full rounded-full bg-sky-400 px-4 py-4 font-semibold text-white transition duration-300 hover:-translate-y-1 hover:scale-105 hover:bg-indigo-500">
                        <span class="font-poppins">Login</span>
                    </button>

                    <a href="./cadastro.php" class="text-blue-500 text-lg md:text-xl">Não possui uma conta? Cadastre-se</a>
                </form>
