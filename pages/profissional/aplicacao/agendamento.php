...
// CONTA OS AGENDAMENTOS PENDENTES
...
if ($totalAgendamentos > 0) {
    ...
    $sql = "SELECT
            ...
            WHERE agendamentos.profissional_id = :profissional_id
            AND agendamentos.status = 'pendente'
...
<body>
        ...
        <div class="mx-auto flex w-full max-w-6xl flex-col overflow-hidden rounded-[2rem] bg-white shadow-[0_20px_60px_rgba(2,132,199,0.2)]">
            ...
            <div class="bg-white px-6 py-6 sm:px-8 lg:px-10">
                ...
                <div class="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
                    ...
                    <a
                        href="./dashboard.php"
                        class="inline-flex items-center justify-center rounded-full border border-gray-200 bg-white px-4 py-2 text-sm font-semibold text-gray-600 shadow-sm transition hover:bg-sky-50"
                    >
                    ...
                    <div class="mt-6 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
                        ...
                        <?php foreach ($agendamentos as $agendamento): ?>
                            ...
                            $diaSemana = $diasSemana[
                                $dataAgendamento->format('l')
                            ];

                            $dataFormatada = $dataAgendamento->format(
                                'd/m/Y'
                            );

                            $horaInicio = $dataAgendamento->format(
                                'H:i'
                            );
                            ...
                            <div class="rounded-[1.25rem] border border-gray-200 bg-white p-4 shadow-sm">
                                ...
                                <div class="mt-4 flex justify-end gap-3">
                                    ...
                                    <form
                                        action="<?= ROOT_PATH ?>actions/aprovacao.php"
                                        method="POST"
                                    ...
                                    >
                                        ...
                                        <button
                                            ...
                                            class="rounded-md border border-green-500 px-3 py-1.5 text-sm font-semibold text-green-600 transition hover:bg-green-500 hover:text-white"
                                        >
                                    ...
                                    <form
                                        action="<?= ROOT_PATH ?>actions/alterar_status_agendamento.php"
                                        method="POST"
                                        class="form-agendamento"
                                    >
                                        ...
                                        <button
                                            ...
                                            class="rounded-md border border-red-500 px-3 py-1.5 text-sm font-semibold text-red-600 transition hover:bg-red-500 hover:text-white"
                                        >
                        ...
                        <div class="flex justify-center items-center gap-2 mt-10">
                            ...
                            <?php if ($pagina > 1): ?>
                                ...
                                <a
                                    ...
                                    class="px-4 py-2 border rounded-lg font-poppins text-sm hover:bg-sky-100 transition"
                                >
                            ...
                            <?php for ($i = 1; $i <= $totalPaginas; $i++): ?>
                                ...
                                <a
                                    href="?pagina=<?= $i ?>"
                                    class="px-4 py-2 rounded-lg font-poppins text-sm transition
                                    <?= $i == $pagina
    ...
    <div
        id="toastConfirmacao"
        class="fixed bottom-6 right-6 z-50 hidden w-[350px] max-w-[calc(100%-2rem)] rounded-2xl bg-white p-5 shadow-2xl border border-gray-200"
    >

        <p
            id="toastMensagem"
            class="text-sm font-poppins text-gray-700"
        ></p>
        ...
        <div class="mt-4 flex justify-end gap-2">
            ...
            <button
                type="button"
                onclick="fecharToast()"
                class="rounded-lg border border-gray-300 px-4 py-2 text-sm font-semibold text-gray-600 transition hover:bg-gray-100"
            >
    ...
    <script>
        ...
        function confirmarAgendamento(
            ...
            formularioSelecionado = botao.closest('form');
            ...
            const mensagemToast = document.getElementById(
                'toastMensagem'
            );
            ...
            if (status === 'confirmado') {
                ...
                btnConfirmar.className =
                    'rounded-lg bg-green-500 px-4 py-2 text-sm font-semibold text-white transition hover:bg-green-600';
