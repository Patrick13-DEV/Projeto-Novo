    ...
    <div class="mx-auto flex w-full max-w-6xl flex-col overflow-hidden rounded-[2rem] bg-white shadow-[0_20px_60px_rgba(2,132,199,0.2)]">
            ...
            <div class="flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between">
                ...
                <div class="max-w-3xl">
                    ...
                    <h1 class="text-2xl font-poppins font-semibold sm:text-3xl">
                        ...
                        Seja Bem-vindo,
                        <?= htmlspecialchars($_SESSION['nomeUser']) ?>!
                ...
                <div class="flex flex-wrap gap-2 self-start">
                    ...
                    <a
                        ...
                        class="inline-flex items-center justify-center rounded-full bg-white px-5 py-2.5 text-sm font-semibold text-sky-800 transition duration-300 hover:bg-sky-100"
                    >
                    ...
                    <a
                        ...
                        class="inline-flex items-center justify-center rounded-full bg-red-500 px-5 py-2.5 text-sm font-semibold text-white transition duration-300 hover:bg-red-600"
                    >
        ...
        <div class="bg-white px-6 py-8 sm:px-8 lg:px-10">
            ...
            <div class="mx-auto flex max-w-4xl flex-col overflow-hidden rounded-[1.5rem] border border-gray-200 shadow-sm sm:flex-row">
                ...
                <img
                    class="h-48 w-full object-cover sm:h-auto sm:w-[45%]"
                    src="../../../assets/img/Doutor.png"
                    alt="Profissional"
                />
                ...
                <div class="flex flex-1 flex-col px-5 py-6">
                    ...
                    <div class="w-full">
                        ...
                        <?php if ($temAgendamentoConfirmado): ?>
                            ...
                            <?php foreach ($agendamentosConfirmados as $agendamento): ?>
                                ...
                                $horaAgendamento = $dataAgendamento->format(
                                    'H:i'
                                );
                                ...
                                <!-- ================================================= -->
                                <!-- CARD DO AGENDAMENTO CONFIRMADO -->
                                <!-- ================================================= -->

                                <div
                                    class="mb-2 flex items-center justify-between gap-3 rounded-xl border border-gray-800 bg-white px-3.5 py-2.5"
                                >
                                    ...
                                    <a
                                        ...
                                        class="shrink-0 rounded-lg bg-sky-500 px-3 py-2 text-xs font-semibold text-white transition hover:bg-sky-600"
                                    >
                    ...
                    <div class="mt-auto pt-5 flex justify-center">
                        ...
                        <div class="flex items-center justify-center gap-4">
                            ...
                            <a
                                href="./agendamento.php"
                                class="relative inline-flex items-center justify-center rounded-full bg-sky-800 px-5 py-2.5 text-sm font-semibold text-white transition duration-300 hover:bg-sky-700"
                            >
                            ...
                            <a
                                href="./historico.php"
                                class="inline-flex items-center justify-center rounded-full border border-sky-800 bg-white px-5 py-2.5 text-sm font-semibold text-sky-800 transition duration-300 hover:bg-sky-50"
                            >
